...
- **IMPORTANT**: Install the following Hotfix to the modlist, install normally with MO2:
[NOIR Custom Patches v1.3 - Hotfix](https://drive.google.com/open?id=1wSy4P6Rtbh3MWyy-GPi_oRdapg8V827V)
